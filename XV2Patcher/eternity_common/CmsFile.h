...
#define XV2_FREE_ID_SEARCH_START 0x95
...
public:
    ...
    inline bool IsSSSS() const { return (type == CmsType::SSSS); }
    inline bool IsXV() const { return (type == CmsType::XV); }
    inline bool IsXV2() const { return (type == CmsType::XV2); }
