...
TiXmlElement *SevEventEntry::Decompile(TiXmlNode *root) const
{
    ...
    Utils::WriteParamUnsigned(entry_root, "CUE_ID", cue_id, (cue_id==0xFFFFFFFF));
    Utils::WriteParamUnsigned(entry_root, "FILE_ID", file_id);
    Utils::WriteParamUnsigned(entry_root, "NU_0C", new_unk_0C, true);
    Utils::WriteParamUnsigned(entry_root, "RESPONSE_CUE_ID", response_cue_id, (response_cue_id==0xFFFFFFFF));
    Utils::WriteParamUnsigned(entry_root, "RESPONSE_FILE_ID", response_file_id);
